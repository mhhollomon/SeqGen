    ...
    return (
        <div className="d-flex flex-column align-items-center third-row" style={{height: '4rem'}}>
            <div className="text-center d-flex flex-row justify-content-between w-5rem align-items-start p-0 m-0" style={{height: '1.0rem'}}>
                <a role="button" aria-label="Add velocity slot before this one" className="p-0 m-0"
                    onClick={() => {}} style={{ height: '1.0rem'}}><i className="bi bi-plus fade-in"></i></a>
                <a role="button" aria-label="Add velocity slot afer this one" className="p-0 m-0 float-end"
                    onClick={() => {}} style={{ height: '1.0rem'}}><i className="bi bi-plus fade-in"></i></a>
            </div>
